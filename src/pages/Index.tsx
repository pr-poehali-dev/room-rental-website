...
const rooms = [
  {
    id: 1,
    name: 'Кабинет №1',
    description: 'Уютное пространство для комфортной работы как для взрослых, так и для детей. Легко создается расслабляющая атмосфера с помощью мягкого освещения.',
